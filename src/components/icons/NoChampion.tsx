export default function NoChampion() {
  return (
    <svg
      ...
      viewBox='0 0 34 34'>
      <defs>
        <circle id='b66oawaf1a' cx='17' cy='17' r='17' />
        <path id='vvt89ckjoc' d='M16.557 22.844L0 22.844 0 0 16.557 0z' />
      </defs>
      <g fill='none' fillRule='evenodd'>
        <g>
          <g>
            <g>
              <g>
                <g transform='translate(-782 -427) translate(489 283) translate(293 52) translate(0 92)'>
                  <mask id='yv3mxmzwgb' fill='#fff'>
                    <use xlinkHref='#b66oawaf1a' />
                  </mask>
                  <use fill='#D7D7D7' xlinkHref='#b66oawaf1a' />
                  <g mask='url(#yv3mxmzwgb)'>
                    <g transform='translate(9 6)'>
                      <mask id='8uprb59lid' fill='#fff'>
                        <use xlinkHref='#vvt89ckjoc' />
                      </mask>
                      <path
                        fill='#999'
